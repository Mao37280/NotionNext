...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '毛家雨', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '毛家雨个人作品集', // 作者简介
  ...
  ...require('./conf/widget.config'),false // 悬浮在网页上的挂件，聊天客服、宠物挂件、音乐播放器等
